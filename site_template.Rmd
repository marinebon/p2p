...
params:
  site_id: "wi-las-cuevas"
  site_name:  "Las Cuevas"
editor_options:
...
if (length(mollusc) == 0)
{print("No data")
  } else if(length(mollusc) > 0){mytext <- paste(mollusc$scientificName, sep="") %>%
...
if (length(echino) == 0)
{print("No data")
  } else if(length(echino) > 0){mytext2 <- paste(echino$scientificName, sep="") %>%
  lapply(htmltools::HTML)
...
if (length(anne) == 0)
{print("No data")
  } else if(length(anne) > 0){mytext3 <- paste(anne$scientificName, sep="") %>%
  lapply(htmltools::HTML)
...
if (length(plant) == 0)
{print("No data")
  } else if(length(plant) > 0){mytext4 <- paste(anne$scientificName, sep="") %>%
  lapply(htmltools::HTML)
