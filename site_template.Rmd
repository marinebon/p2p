...
total <- bind_rows(mollusc, echino, anne, plant)
total <- data.frame(total$date_year, total$phylum)
names(total)[names(total) == "total.date_year"] <- "year"
names(total)[names(total) == "total.phylum"] <- "phylum"
